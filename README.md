> [!NOTE]
> This repository is a fork of [Wallpaper Picker](https://github.com/magetsu002/qs-wallpaper-picker) by **@magetsu002**. All credits for the original project belong to the original author. This fork includes custom patches that add wallpaper synchronization, multi-instance prevention and some other fixes.
